...
public class CommandParser {
    ...
    public static CommandGroup parseStringToCommandGroup(String stringToParse, boolean printDebug, boolean outputToDriverStation){
        ...
        while(currentIndex < newSequence.length() && shouldRun){
                ...
                //Checks if there is a command that has the identifying letter
            ...
            if(_output){
                SmartDashboard.putString("DB/String 0", returnString + "                             ");
                SmartDashboard.putString("DB/String 1", successful + "                             ");
                SmartDashboard.putString("DB/String 2", Timer.getFPGATimestamp() + "                          ");
            }
